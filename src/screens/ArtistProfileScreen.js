...
const ArtistProfileScreen = () => {
  ...
  const { isFetching, isError, isSuccess, artist, musics, followers, isFollowed } =
    ...
    <div className='main-container'>
      <div className="artist-header-subcontainer">
        ...
        <div className="header-action-bar">
          <button type="button" className="btn btn-gradient-hover btn-profile-play" onClick={handlePlayAll}>
          ...
          <div className="p-0 m-0">
            {!followed ?
              (<button type="button" className="btn btn-follow mr-4" onClick={onFollow}>
              ...
              (
                <button type="button" className="btn btn-follow mr-4" onClick={onUnFollow}>
            ...
            <button type="button" className="btn btn-gradient-hover btn-alt-tip ">
