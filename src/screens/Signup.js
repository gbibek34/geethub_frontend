        ...
        <div className="container row col-lg-8 col-sm-11 p-0 shadow bg-white">
          ...
          <div className="col-lg-6 p-0 m-0 loginPic">
            ...
            <div className="text-center p-0 m-auto rounded-0">
              <img className="w-100 h-100" src={signupPicture} alt="a happy picture" />
            </div>
          </div>
          ...
          <div className="col-lg-6 p-0 m-0 align-content-center">
            ...
            <div className=" text-center w-100 py-5 h-100 rounded-0 justify-content-center">
              ...
              <form action="post" onSubmit={onSubmitHandler} className="form-signin mt-5">
                ...
                <div className="mb-3 px-4">
                  ...
                  <div className="form-group mb-3">
                    <input type="text" id="inputName" value={enteredName} onChange={onNameChangeHandler} className=" form-control border" placeholder="name" required />
                  </div>

                  <div className="form-group mb-3">
                    <input type="email" id="inputEmail" value={enteredEmail} onChange={onEmailChangeHandler} className=" form-control border" placeholder="email" required />
                  </div>

                  <div className="form-group mb-5 mx-1 row p-0">
                    <input type="password" id="inputPassword" value={enteredPassword} onChange={onPasswordChangeHandler} className="form-control border col-lg-6 halfEntry"
                      placeholder="password" required />
                    <input type="password" id="inputPassword" value={enteredRePassword} onChange={onRePasswordChangeHandler} className=" form-control border col-lg-6"
                  ...
                  <div className="loginButtonGroup form-group mb-4">
                    <button className="loginContinue btn btn-lg  btn-info btn-cyan btn-block border-0"
                      type="submit">Continue</button>
                    <Link to="/login" className="gotoSignup btn btn-link">Already
