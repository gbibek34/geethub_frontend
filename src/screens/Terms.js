    ...
    <div className="overflow-auto terms-background">
      <div className="rounded bg-white overflow-auto terms-container">
        ...
        <p>
          ...
          use of Geethub's Website, located at www.geethub.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Geethub if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Geethub, you agreed to use
          cookies in agreement with the Geethub's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Geethub and/or its licensors own the
          intellectual property rights for all material on Geethub. All
          intellectual property rights are reserved. You may access this from
          Geethub for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          Geethub does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Geethub,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Geethub shall not be liable
        ...
        <p>
          Geethub reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Geethub a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Geethub; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Geethub. Please include your name, your
        ...
        <p>
          No use of Geethub's logo or other artwork will be allowed for linking
